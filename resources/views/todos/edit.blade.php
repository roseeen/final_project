                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('todos.update', $todo->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="description">{{ $todo->description }}</textarea>
